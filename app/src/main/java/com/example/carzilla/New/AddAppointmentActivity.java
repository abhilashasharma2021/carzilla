...
public class AddAppointmentActivity extends AppCompatActivity {
    ...
    String strShopID="";
    EditText edtVechileNumber,edtDateofBirth,edtCustomername,edtPhoneNumber,edtEmail,edtddress,edtRemark;
        ...
        btnAppointment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (stredtVechileNumber.equals("")){
                    Toast.makeText(AddAppointmentActivity.this, "please enter vehicle number", Toast.LENGTH_SHORT).show();
                }else if (stredtDateofBirth.equals("")){
                    Toast.makeText(AddAppointmentActivity.this, "please enter date of birth ", Toast.LENGTH_SHORT).show();
                }else if (stredtCustomername.equals("")){
                    Toast.makeText(AddAppointmentActivity.this, "please enter name ", Toast.LENGTH_SHORT).show();
                }else if (stredtPhoneNumber.equals("")){
                    Toast.makeText(AddAppointmentActivity.this, "please enter phone number", Toast.LENGTH_SHORT).show();
                }else if (stredtEmail.equals("")){
                    Toast.makeText(AddAppointmentActivity.this, "please enter email ", Toast.LENGTH_SHORT).show();
                }
                else if (!stredtEmail.matches(emailPattern)) {
                    Toast.makeText(AddAppointmentActivity.this, "Invalid email", Toast.LENGTH_SHORT).show();

                } else if (stredtddress.equals("")){
                    Toast.makeText(AddAppointmentActivity.this, "please enter address", Toast.LENGTH_SHORT).show();
                }else if (stredtRemark.equals("")){
                    Toast.makeText(AddAppointmentActivity.this, "please enter remark", Toast.LENGTH_SHORT).show();
                }else{
...
*/
    ...
    public void AddAppointment(String stredtVechileNumber, String stredtDateofBirth, String stredtCustomername, String stredtPhoneNumber, String stredtEmail, String stredtddress, String stredtRemark) {
        ...
        dialog.show();
        AndroidNetworking.post(BaseUrl.create_appointment)
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (response.getString("message").equals("successful")) {
                                dialog.dismiss();
                                Toast.makeText(AddAppointmentActivity.this, response.getString("message"), Toast.LENGTH_SHORT).show();
                                finish();
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            ArrayAdapter adapter = new ArrayAdapter(AddAppointmentActivity.this, android.R.layout.simple_spinner_item, arrayMakeModelName);
