...
public class ShowCompletedOrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_completed_order);
        ...
        layoutManager = new GridLayoutManager(ShowCompletedOrderActivity.this, 1, RecyclerView.VERTICAL, false);
        ...
        imgAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ShowCompletedOrderActivity.this,RepairOrderActivity.class));
            }
        });
        show_Favourite();
    ...
    public void show_Favourite() {
        final ProgressDialog dialog = new ProgressDialog(ShowCompletedOrderActivity.this);
        dialog.setMessage("please wait..");
        dialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        dialog.show();
        AndroidNetworking.post(BaseUrl.show_order)
                .addBodyParameter("shop_id",strShopID)
                .addBodyParameter("order_status","2")
                ...
                .getAsJSONObject(new JSONObjectRequestListener() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            layoutManager = new GridLayoutManager(ShowCompletedOrderActivity.this, 1, RecyclerView.VERTICAL, false);
                            rec_favourite.setLayoutManager(layoutManager);
                            favouriteAdapter = new ShowCreateeAdapter(ShowCompletedOrderActivity.this, arrayListFavourite);
